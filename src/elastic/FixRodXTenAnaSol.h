//---------------------------------------------------------------------------
//柱体受集中力均匀拉伸位移场
#ifndef FixRodXTenAnaSolH
#define FixRodXTenAnaSolH
//---------------------------------------------------------------------------
#include <vector>
...
#include "MatPro.h"
//---------------------------------------------------------------------------
class FixRodXTenAnaSol : public AnalyticalSolution{
public:
        FixRodXTenAnaSol(){};                        //默认构造函数
        FixRodXTenAnaSol( double area, double T ) ;
                                                    //构造函数
