//---------------------------------------------------------------------------
//圆截面柱形杆的扭转位移场
#ifndef FixRodZTwistAnaSolH
#define FixRodZTwistAnaSolH
//---------------------------------------------------------------------------
#include <vector>
...
#include "MatPro.h"
//---------------------------------------------------------------------------
class FixRodZTwistAnaSol : public AnalyticalSolution{
public:
        FixRodZTwistAnaSol(){};                    //默认构造函数
        FixRodZTwistAnaSol( double r, double T ) ;
                                                    //构造函数
