//---------------------------------------------------------------------------
//圆截面柱形杆的扭转位移场
#ifndef FixRodYTwistAnaSolH
#define FixRodYTwistAnaSolH
//---------------------------------------------------------------------------
#include <vector>
...
#include "MatPro.h"
//---------------------------------------------------------------------------
class FixRodYTwistAnaSol : public AnalyticalSolution{
public:
        FixRodYTwistAnaSol(){};                    //默认构造函数
        FixRodYTwistAnaSol( double r, double T ) ;
                                                    //构造函数
