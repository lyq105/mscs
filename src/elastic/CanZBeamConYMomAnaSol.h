//---------------------------------------------------------------------------
//悬臂梁纯弯曲位移场
#ifndef CanZBeamConYMomAnaSolH
#define CanZBeamConYMomAnaSolH
//---------------------------------------------------------------------------
#include <vector>
...
#include "MatPro.h"
//---------------------------------------------------------------------------
class CanZBeamConYMomAnaSol : public AnalyticalSolution{
public:
        CanZBeamConYMomAnaSol(){};                    //默认构造函数
        CanZBeamConYMomAnaSol( BeamSecShape* bss, double M ) ;
                                                    //构造函数
