//---------------------------------------------------------------------------
//悬臂梁纯弯曲位移场
#ifndef CanXBeamConZMomAnaSolH
#define CanXBeamConZMomAnaSolH
//---------------------------------------------------------------------------
#include <vector>
...
#include "MatPro.h"
//---------------------------------------------------------------------------
class CanXBeamConZMomAnaSol : public AnalyticalSolution{
public:
        CanXBeamConZMomAnaSol(){};                    //默认构造函数
        CanXBeamConZMomAnaSol( BeamSecShape* bss, double M ) ;
                                                    //构造函数
